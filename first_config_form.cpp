...
//		InfoAction("Тест подключения прошёл успешно. Настройки сохранены. Переходим к следующему шагу", true, 0, 0);
//		pages->TabIndex = 2;
//	} else {
//		InfoAction("Возникла ошибка при тесте соединения. Содержание ошибки можно посмотреть в логах."
//							 "Пожалуйста проверьте настройки БД и плагина",
//							 true, 0, 1
//		 );
//	}
}
...
void __fastcall TFastConfigForm::end_butClick(TObject *Sender) {
	...
	// Функция возвратит результат запроса, а если он был false, то и сразу покажет ошибку.
