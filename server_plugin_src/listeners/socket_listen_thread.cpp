...
SocketСonnections socket_connections;
...
int GetCleanMessageLength(SocketСonnection &conn, char *received_data, int len) {
	...
	if (conn.json_length_received) {
		/* TODO : Сделать обработку ошибки приведения типа */
